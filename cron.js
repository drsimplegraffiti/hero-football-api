...
// In heroku worker process doesn't have access to file storage
...
const baseUrl =
  ...
  `https://apiv3.apifootball.com/?action=get_events&from=${startDate}&to=${endDate}&league_id=248&APIkey=ed2a9573227f81ca3da6755c16c77e093e37d5dc671ec360aef0e2a92734312b`;
var options = {
  method: "GET",
  url: baseUrl,
};
